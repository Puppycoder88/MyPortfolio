      ...
      <h2 className="text-2xl font-semibold text-center">Projects</h2>
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="bg-gray-800 p-4 rounded-lg">
            <h3 className="text-xl font-semibold">Gemba InfoTech Website</h3>
            <p className="text-gray-400">React.js, Tailwind CSS, Node.js, MySQL, Nodemailer, Mobile Responsive</p>
          </div>
          <div className="bg-gray-800 p-4 rounded-lg">
